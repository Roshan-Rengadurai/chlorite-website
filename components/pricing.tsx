export function Pricing() {
    const plans = [
        {
            ...
            features: ["Unlimited basic notes", "Markdown support", "Web access", "3 device-sync", "Community support"],
            cta: "Get Started",
            popular: false,
        },
        {
    ...
    return (
        <div id="pricing" className="container px-6 md:px-12 pt-12 pb-12 mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black dark:text-white">Simple, Transparent Pricing</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Choose the plan that works best for you.</p>
            </div>
            ...
            {plans.map((plan) => (
                <div
                key={plan.name}
                className={`bg-white dark:bg-gray-900 rounded-xl p-8 border ${plan.popular ? "border-purple-500" : "border-gray-300 dark:border-gray-800"
                ...
                <div className="mb-6">
                    ...
                    {plan.price}
                    <span className="text-gray-600 dark:text-gray-400 text-base font-normal ml-1">{plan.price !== "$0" && "/mo"}</span>
                    </div>
