    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full flex justify-center mt-6">
        <div className="bg-secondary/30 backdrop-blur-sm rounded-full px-4 py-2 flex items-center">
          ...
          >
            Real-time collaboration, dark mode, and more!
          </span>
        </div>
      </div>
      ...
      <section className="w-full py-20 md:py-32 flex justify-center items-center relative overflow-hidden">
        {/* Background light effects (idk if these work, but imma leave them here)*/}
        <div className="absolute top-1/4 -left-1/4 w-1/2 h-1/2 bg-purple-500/20 rounded-full blur-3xl opacity-100 animate-pulse"></div>
        <div
          className="absolute bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-orange-400/20 rounded-full blur-3xl opacity-100 animate-pulse"
        ...
        <div className="container px-4 md:px-6 flex flex-col items-center text-center relative z-10">
          ...
          <div className="mb-8">
            <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-purple-400 via-purple-600 to-purple-800 p-0.5 shadow-xl">
              <div className="h-full w-full rounded-2xl bg-white flex items-center justify-center dark:bg-black">
                <span className="font-bold text-black text-3xl dark:text-white">Ch</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 max-w-3xl">
            <h1
              className={cn(
                "text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl/none",
                "text-black dark:text-white"
              )}
            >
              Notes Like{" "}
            ...
            <p
              className={cn(
                "mx-auto max-w-[700px] text-xl md:text-2xl",
                "text-muted-foreground dark:text-muted-foreground-light"
              )}
            >
